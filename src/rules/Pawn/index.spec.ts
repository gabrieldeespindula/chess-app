...
describe('PawnRule', () => {
  describe('isValidMove', () => {
    ...
    describe('when the piece moves one square forward', () => {
    ...
    describe('when the piece moves two square forward', () => {
    ...
    describe('when the piece moves one square diagonally', () => {
